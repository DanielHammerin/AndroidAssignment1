...
public class PagerAdapter extends FragmentPagerAdapter {
    ...
    public PagerAdapter(FragmentManager fm) {
        ...
        fragments[0] = BeerFragment.newFragment(0, R.drawable.img1, "Mornin' Delight", "Name: Mornin' Delight\n" +
                "Rating: 4.7\n" +
        ...
        fragments[1] = BeerFragment.newFragment(1, R.drawable.img2,"Good Morning", "Name: Good Morning\n" +
                "Rating: 4.7\n" +
        ...
        fragments[2] = BeerFragment.newFragment(2, R.drawable.img3, "Pliny, the Younger", "Name: Pliny The Younger\n" +
                "Rating: 4.68\n" +
        ...
        fragments[3] = BeerFragment.newFragment(3, R.drawable.img4, "Heady Topper", "Name: Heady Topper\n" +
                "Rating: 4.67\n" +
        ...
        fragments[4] = BeerFragment.newFragment(4, R.drawable.img5, "Kentuchy Brunch Brand Stout", "Name: Kentucky Brunch Brand Stout\n" +
                "Rating: 4.66\n" +
                "Brewery: Toppling Goliath Brewing Company, Iowa, United States\n" +
                "Style: American Double / Imperial Stout\n" +
                "ABV: 12.00%\n" +
        ...
        fragments[5] = BeerFragment.newFragment(5, R.drawable.img6, "Pliny, The Elder", "Name: Pliny The Elder\n" +
                "Rating: 4.59\n" +
                "Style: American Double / Imperial IPA\n" +
        ...
        fragments[6] = BeerFragment.newFragment(6, R.drawable.img7, "Norrlands Guld Export", "Name: Norrlands Guld Export\n" +
                "Rating: 2.62\n" +
